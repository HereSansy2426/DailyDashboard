...
class SignUpApp(ctk.CTk):
    def __init__(self):
        ...
        # Pencere Ayarları
        self.title("Daily Dashboard - Sign Up")
    ...
    def create_main_card(self):
        ...
        # İsim Alanı
        self.name_entry = self.create_input_field("Name", "Enter your name", "👤")

        # Kullanıcı Adı Alanı
        self.username_entry = self.create_input_field("Username", "Enter your username", "✉️")

        # Şifre Alanı
        self.password_entry = self.create_input_field("Password", "••••••••", "🔒", is_password=True)
    ...
    def handle_signup(self):
        ...
        # IMPORTANT: name_entry -> name column, username_entry -> username column
        ...
        try:
            ...
            connection = mysql.connector.connect(
                host="fedora",
                user="root",
                password="qAzWsX!1928",  # root için şifre yoksa boş bırak
                database="dailydashboard"
            )
            cursor = connection.cursor()

            # Username check (already exists?)
            ...
            messagebox.showinfo("Success", "Registration successful! Redirecting to Sign in page...")
    ...
    def open_signin(self):
        """Opens the Sign in page and closes the signup window"""
